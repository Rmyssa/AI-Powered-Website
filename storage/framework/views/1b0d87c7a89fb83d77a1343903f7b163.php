...
<header>
    ...
    <div class="profile-pic" onclick="toggleProfileMenu()">
        <img src="<?php echo e(Auth::user()->profile_photo ? Storage::url(Auth::user()->profile_photo) : asset('default-avatar.png')); ?>" alt="Profil Fotoğrafı">
    </div>

    <!-- Profil Menü -->
    <div class="profile-menu" id="profileMenu">
        <a href="<?php echo e(route('profile.edit')); ?>">Profil Düzenle</a>
...
<?php /**PATH C:\Users\PC\Desktop\stajweb\stajweb\resources\views/recommendations.blade.php ENDPATH**/ ?>